...
var Minifier = (function () {
    ...
    Minifier.prototype.transform = function (bundleSourceFile) {
        return this.bundleSourceFile = bundleSourceFile;
        //return this.minify( bundleSourceFile );
    };
    Minifier.prototype.addToContainerChain = function (nextContainer) {
        if (this.lastContainer) {
            this.lastContainer.nextContainer = nextContainer;
        }
        this.lastContainer = nextContainer;
    };
    Minifier.prototype.walkContainerChain = function (head) {
